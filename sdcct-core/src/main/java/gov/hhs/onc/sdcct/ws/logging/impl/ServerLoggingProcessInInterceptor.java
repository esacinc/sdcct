...
public class ServerLoggingProcessInInterceptor extends AbstractLoggingProcessInInterceptor<WsRequestEvent> {
    public ServerLoggingProcessInInterceptor(SdcctLoggingFeature feature, WsMessageType msgType) {
