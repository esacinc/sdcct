...
public final class DbTableNames {
    ...
    public final static String FORM_RESP_PREFIX = FORM_PREFIX + "resp_";
    ...
    public final static String FORM_RESP_FHIR = FORM_RESP_PREFIX + FHIR_SUFFIX;
    public final static String FORM_RFD = FORM_PREFIX + RFD_SUFFIX;
    public final static String FORM_RESP_RFD = FORM_RESP_PREFIX + RFD_SUFFIX;
