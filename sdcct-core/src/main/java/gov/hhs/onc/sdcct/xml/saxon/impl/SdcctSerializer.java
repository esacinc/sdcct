...
import gov.hhs.onc.sdcct.config.SdcctOptionValues;
...
public class SdcctSerializer extends Serializer {
    ...
    public SdcctSerializer(SdcctSaxonProcessor processor) {
        super(processor);
    ...
    public <T extends Result> T serialize(Source src, T result, @Nullable ParseOptions parseOpts, @Nullable Properties outProps) throws SaxonApiException {
        SdcctSaxonConfiguration config = this.getProcessor().getUnderlyingConfiguration();
    ...
    public Receiver getReceiver(PipelineConfiguration pipelineConfig) throws SaxonApiException {
        return this.getReceiver(((SdcctSaxonConfiguration) pipelineConfig.getConfiguration()), ((SdcctPipelineConfiguration) pipelineConfig), this.getResult(), null,
            null);
    }

    public Receiver getReceiver(SdcctSaxonConfiguration config, SdcctPipelineConfiguration pipelineConfig, Result result, @Nullable ParseOptions parseOpts,
        ...
        outProps.setProperty(INDENT_OUT_PROP_KEY, SdcctOptionValues.NO);
