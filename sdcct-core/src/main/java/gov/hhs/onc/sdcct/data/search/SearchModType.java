...
public enum SearchModType implements IdentifiedBean {
    MISSING(null, SearchParamType.values()), EXACT(null, SearchParamType.STR), CONTAINS(null, SearchParamType.STR), TEXT(null, SearchParamType.TOKEN), IN(null,
        SearchParamType.TOKEN), NOT_IN("not-in", SearchParamType.TOKEN), TYPE(null, SearchParamType.REF), BELOW(null, SearchParamType.TOKEN,
        SearchParamType.URI), ABOVE(null, SearchParamType.TOKEN, SearchParamType.URI);
