...
import gov.hhs.onc.sdcct.xml.StaticXmlOptions;
...
public abstract class AbstractStaticXmlOptions<T extends StaticXmlOptions<T>> extends AbstractXmlOptions<T> implements StaticXmlOptions<T> {
    ...
    protected AbstractStaticXmlOptions(Supplier<T> optsBuilder) {
        super(optsBuilder);
    }
