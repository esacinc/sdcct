...
public final class SdcctUris {
    ...
    public final static String IHE_QRPH_SDC_URN_NSS = "qrph:sdc:2016";
    public final static String IHE_QRPH_SDC_URN_VALUE = IHE_URN_PREFIX + IHE_QRPH_SDC_URN_NSS;
    public final static URI IHE_QRPH_SDC_URN = URI.create(IHE_QRPH_SDC_URN_VALUE);
    ...
    public final static String SDCCT_VALIDATE_URN_NSS = "validate";
    public final static String SDCCT_VALIDATE_URN_VALUE = SDCCT_URN_PREFIX + SDCCT_VALIDATE_URN_NSS;
    public final static URI SDCCT_VALIDATE_URN = URI.create(SDCCT_VALIDATE_URN_VALUE);
